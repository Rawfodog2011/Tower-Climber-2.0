...
export type CombatEvent =
  ...
  | { type: 'BOSS_PUZZLE_RESULT'; success: boolean }
  | { type: 'MONSTER_STUNNED_SKIP'; monsterName: string }
  | { type: 'STAGGER_FAIL'; monsterName: string }
  | { type: 'DEBUFF_RESISTED'; target: CombatTarget };
