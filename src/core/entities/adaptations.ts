...
export const ADAPTATIONS_DATABASE: Record<string, AdaptationDef> = {
  'blindagem_reativa': {
    ...
    description: 'Resistência ao impacto calibra o chassi. Melhora ao receber dano em combate (1 EXP por HP perdido). Concede +1 DEF por nível.',
    maxLevel: 10,
  ...
  'nanocelulas_regenerativas': {
    ...
    description: 'Sobrevivência estendida multiplica as nanocélulas. Melhora ao sobreviver a turnos em combate (25 EXP por turno). Concede +15 HP por nível.',
    maxLevel: 10,
  ...
  'overclock_combate': {
    ...
    description: 'Repetição de ataques afia os servos do traje. Melhora ao realizar ataques básicos em combate (20 EXP por ataque). Concede +2 ATK por nível.',
    maxLevel: 10,
  ...
  'sincronia_neural': {
    ...
    description: 'Reflexos em combate constante aceleram as sinapses. Melhora ao desferir ataques básicos (10 EXP por ataque) ou sobreviver a turnos (15 EXP por turno) em combate. Concede +1 SPD por nível.',
    maxLevel: 10,
  ...
  'dissipacao_calor': {
    ...
    description: 'Uso de habilidades expande as baterias internas. Melhora ao conjurar habilidades (10 EXP por uso) e ao consumir pontos de Energia/EP (1 EXP por EP gasto). Concede +5 Max EP por nível.',
    maxLevel: 10,
  ...
  'colosso_carbono': {
    ...
    description: 'Fusão de Blindagem Reativa e Nanocélulas. O chassi se torna impenetrável. Melhora realizando ações e sobrevivendo a turnos em combate (15 EXP por ação/turno) ou recebendo dano. Concede +5 DEF e +50 HP por nível. Desbloqueia "Fortaleza Biomecânica".',
    maxLevel: 10,
  ...
  'assassino_navalha': {
    ...
    description: 'Fusão de Overclock e Sincronia Neural. Velocidade e letalidade máximas. Melhora realizando ações e sobrevivendo a turnos em combate (15 EXP por ação/turno) ou recebendo dano. Concede +5 ATK e +3 SPD por nível. Desbloqueia "Golpe Fantasma".',
    maxLevel: 10,
  ...
  'nucleo_fissao': {
    ...
    description: 'Fusão de Overclock e Dissipação de Calor. Agressividade energética insana. Melhora realizando ações e sobrevivendo a turnos em combate (15 EXP por ação/turno) ou recebendo dano. Concede +8 ATK e +20 EP por nível. Desbloqueia "Exaustão Térmica".',
    maxLevel: 10,
